...
public class frmNhanVien extends javax.swing.JFrame {
    ...
    NhanVienBLL nvdll = new NhanVienBLL();
    ...
    public void binData(String t, String w, String o) {
        ...
        for (NhanVien i : lst) {
            ...
            row.add(i.getmaNhanVien());
            row.add(i.gettenNV());
            row.add(i.getgioiTinhNV());
         
            row.add(i.getdiaChiNV());
            row.add(i.getsoDienThoaiNV());
            row.add(i.getchucVu());
    ...
    private void initComponents() {
        ...
        setTitle("Quản Lý Nhân Viên | Phần Mềm Quản Lý Cửa Hàng Bán Sách Fahasa");
        setAlwaysOnTop(true);
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                        ...
                        .addComponent(txtchucvu, javax.swing.GroupLayout.PREFERRED_SIZE, 171, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void tbNVMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbNVMouseClicked
        ...
        txtchucvu.setText(tbNV.getValueAt(row, 5).toString());
    ...
    private void btnThemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnThemActionPerformed
        ...
        data.setmaNhanVien(txtMaNV.getText());
        if (txtTenNV.getText().equals("")) {
            JOptionPane.showMessageDialog(this, "Tên Nhân Viên trống!");
            return;
        }
        data.settenNV(txtTenNV.getText());
        ...
        data.setdiaChiNV(txtDiaChiNV.getText());
    ...
    private void btnSuaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSuaActionPerformed
        ...
        if (row >= 0) {
            ...
            data.setgioiTinhNV(txtGioiTinhnv.getText());
            ...
            data.setmaNhanVien(id);
            if (JOptionPane.showConfirmDialog(this, "Bạn muốn thêm bản ghi?", "Thông báo!!!", JOptionPane.YES_NO_OPTION) == JOptionPane.YES_OPTION) {
                if (nvdll.updateData(data)) {
                    binData("", "", "");
